...
Mobile-first PWA for confidential medical burnout triage and support. See `documentacao-produto/prd.md` for product requirements and `docs/superpowers/specs/2026-07-07-pwa-architecture.md` for the technical architecture.
